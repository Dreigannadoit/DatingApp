...
const StreamChatInterface = ({ otherUser, ref }: { otherUser: UserProfile; ref: RefObject<{ handleVideoCall: () => void } | null> }) => {
    ...
    const [showVideoCall, setShoeVideoCall] = useState(false)
